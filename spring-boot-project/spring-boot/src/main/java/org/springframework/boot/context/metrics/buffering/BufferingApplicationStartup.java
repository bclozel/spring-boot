...
public class BufferingApplicationStartup implements ApplicationStartup {
	...
	public void startRecording() {
		Assert.isTrue(this.recordedSteps.isEmpty(), "Cannot restart recording once steps have been buffered.");
	...
	public StartupStep start(String name) {
		...
		step.getTimeRecord().recordStartTime(getCurrentTime());
		this.currentSteps.offerFirst(this.currentSequenceId);
		return step;
	}

	private void record(BufferedStartupStep step) {
		step.getTimeRecord().recordEndTime(getCurrentTime());
