...
class AccessLevelTests {
	...
	@Test
	void accessToProbesEndpointShouldNotBeRestricted() {
		assertThat(AccessLevel.RESTRICTED.isAccessAllowed("probes")).isTrue();
		assertThat(AccessLevel.FULL.isAccessAllowed("probes")).isTrue();
	}
